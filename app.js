  ...
  ,
{
  ...
  lng: -77.15633,
  fotos: [
    'imagenes/buesaco pue.png',
    'imagenes/fonda de gallo2.png',
    'imagenes/fonda del gallo.png',
    'imagenes/las vallas.png',
    'imagenes/little berry.png',
    'imagenes/hotel cafepla.png',
    'imagenes/hotelpuebla.png'
  ],
  curiosidad: '¿Sabías que Buesaco cuenta con el mejor clima del mundo y una gran variedad de estaderos turísticos?',
  info: {
    comer: [
      { nombre: 'Restaurante La fonda del gallo', direccion: '25 #17-23, Buesaco, Nariño', desc: 'Almuerzos desde $30.000 hasta $40.000', lat: 1.39567, lng: -77.15236 },
      { nombre: 'Restaurante Las Vallas', direccion: '#18-2 a 18-350', desc: 'Almuerzos desde $10.000 hasta $20.000', lat: 1.37713, lng: -77.15816 },
      { nombre: 'Restaurante Mirador Paso Ancho', direccion: 'Avenida principal casa 1 Esquina, Pasoancho, Buesaco, Nariño', desc: 'Almuerzos $40.000: especialidad filete al barril', lat: 1.38310, lng: -77.15774 },
      { nombre: 'Cafetería Little Berry', direccion: 'Cra. 2 #12-98, Buesaco, Nariño', desc: 'Café, chocolate, aromáticas, empanadas, buñuelos y todo en panadería: precios desde $10.000', lat: 1.38145, lng: -77.15713 }
    ],
    hospedarse: [
      { nombre: 'Hotel Café Plaza', direccion: 'Cra. 2 #No 6-71, Buesaco, Nariño', desc: 'Cuenta con piscina para sus huéspedes, costo de $40.000 cama individual y de $60.000 con cama doble por noche', lat: 1.38530, lng: -77.15598 },
      { nombre: 'Hotel Puebla', direccion: 'Cra. 2 #81 a 8-71, Buesaco, Nariño', desc: 'Habitaciones desde $30.000 hasta $50.000 por noche', lat: 1.38482, lng: -77.15614 },
      { nombre: 'Hostel Lumar', direccion: 'Buesaco - Villamoreno #101, Buesaco, Nariño', desc: 'Con un costo de $40.000 y $65.000 por noche', lat: 1.38409, lng: -77.15653 },
      { nombre: 'Hotel del Río', direccion: 'Centro norte, Cra. 3 #6- 82, Buesaco, Nariño', desc: 'Un costo de $60.000 por noche, desayuno incluido', lat: 1.38650, lng: -77.15614 }
    ],
    hacer: [
      { nombre: 'Buesaquito', direccion: 'Buesaco, Nariño', desc: 'Con piscina, restaurante, hotel. Ubicado a 40 minutos de la ciudad capital y a tan solo 7 minutos del casco urbano de Buesaco, cuesta 8 mil pesos de ingreso por persona', lat: 1.35352, lng: -77.17410 },
      { nombre: 'Santuario de la Virgen de Lourdes', direccion: 'Buesaco, Nariño', desc: 'Ubicada a 40 minutos de la ciudad capital a tan solo 7 minutos del casco urbano de Buesaco, justo al lado del estadero Buesaquito, puedes visitarla totalmente gratis', lat: 1.35403, lng: -77.17296 },
      { nombre: 'El Corral', direccion: 'Vía a Buesaco, Buesaco, Nariño', desc: 'Cuenta con piscina 6 mil por persona, hotel $60.000 y $80.000, restaurante, glamping $200.000 por pareja', lat: 1.36848, lng: -77.16454 }
    ]
  }
},
{
  ...
  {
    id: 'El tablon de gomes',
    nombre: 'El Tablon de Gomes',
    lat: 1.42234,
    lng: -77.08202,
...
function initMap() {
  ...
  // ✅ Cerrar panel al cargar (por si quedó abierto vacío)
  cerrarPanelMunicipio();

  // ✅ Abrir notificaciones al cargar
  setTimeout(() => {
    document.getElementById('popupNotificaciones').classList.remove('oculto');
  }, 1000);
}
...
function cargarMunicipiosTuristicos() {
  MUNICIPIOS_TURISTICOS.forEach(municipio => {
    ...
    // ✅ Clic simple: abre info del municipio
...
// Abrir y cerrar notificaciones
document.getElementById('btnNotificaciones').addEventListener('click', () => {
  document.getElementById('popupNotificaciones').classList.remove('oculto');
});

function cerrarNotificaciones() {
  document.getElementById('popupNotificaciones').classList.add('oculto');
}

// Abrir y cerrar recomendaciones
document.getElementById('btnRecomendaciones').addEventListener('click', () => {
  document.getElementById('popupRecomendaciones').classList.remove('oculto');
});

function cerrarRecomendaciones() {
  document.getElementById('popupRecomendaciones').classList.add('oculto');
}